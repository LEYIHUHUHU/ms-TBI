...
var app = angular.module("myApp", [
    ...
    "myApp.directives", "myApp.controllers",'rzModule'
]);
...
app.config(["$routeProvider",
    function ($routeProvider) {
        ...
        $routeProvider.when("/ventilator", {
            templateUrl: "partials/ventilator.html"
        });
        ...
        $routeProvider.when("/comfort", {
            templateUrl: "partials/comfort.html"
        });
        $routeProvider.when("/survival", {
        ...
        $routeProvider.when("/worksheet", {
            templateUrl: "partials/worksheet.html",
...
// redirect the user back to the welcome page if auth error is catched
